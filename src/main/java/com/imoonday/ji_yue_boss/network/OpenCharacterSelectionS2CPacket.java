...
public record OpenCharacterSelectionS2CPacket(CharacterReceiver.Context context) implements NetworkPacket {

    public OpenCharacterSelectionS2CPacket(FriendlyByteBuf buffer) {
    ...
    public void handle(NetworkEvent.Context ctx) {
        ...
        ClientUtil.openCharacterSelectionScreen(context);
    }
}
